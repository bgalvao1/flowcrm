...
const NAV = [
  ...
  { section: 'Operação', items: [
    ...
    { to: '/timesheet', label: 'Timesheet', key: null, icon: I('M8 4v4l3 3', <circle cx="8" cy="8" r="6.5" stroke="currentColor" strokeWidth="1.5"/>) },
    { to: '/conteudo', label: 'Calendário Editorial', key: null, icon: I('M5 1v3M11 1v3M2 7h12M5 11h2M9 11h2M5 13.5h2', <rect x="2" y="3" width="12" height="11" rx="2" stroke="currentColor" strokeWidth="1.5"/>) },
  ]},
  { section: 'Comercial', items: [
    ...
    { to: '/relatorios', label: 'Relatórios IA', key: null, icon: I('M4 12V4M8 12V7M12 12V2', <rect x="2" y="1" width="12" height="14" rx="2" stroke="currentColor" strokeWidth="1.5" opacity=".4"/>) },
    { to: '/onboarding', label: 'Onboarding', key: null, icon: I('M8 2l1.5 5h5l-4 3 1.5 5L8 12l-4 3 1.5-5-4-3h5z') },
    { to: '/indicacoes', label: 'Indicações', key: null, icon: I('M10 8a2 2 0 11-4 0 2 2 0 014 0zM14 14a6 6 0 00-12 0') },
    { to: '/precificacao', label: 'Precificação', key: null, icon: I('M8 2v12M5 5h6M5 11h4', <circle cx="8" cy="8" r="6.5" stroke="currentColor" strokeWidth="1.5" opacity=".4"/>) },
    { to: '/reativacao', label: 'Reativação', key: null, icon: I('M1 8s2-5 7-5 7 5 7 5-2 5-7 5-7-5-7-5z', <circle cx="8" cy="8" r="2.5" stroke="currentColor" strokeWidth="1.5"/>) },
  ]},
  { section: 'Gestão', items: [
    ...
    { to: '/crm-access', label: 'Acesso CRM', key: null, icon: I('M2 8h12M2 12h8', <rect x="2" y="4" width="12" height="10" rx="2" stroke="currentColor" strokeWidth="1.5" opacity=".5"/>) },
